...
import { useNavigate } from 'react-router-dom';
    ...
    // START MAP VIEWER COMPONENT
      const MapViewer = ({ selectedLocation = "goddard", locationsDataUrl = null }) => {
        ...
        const handleShowDatagram = (locationKey) => {
          navigate(`/datagram-viewer?location=${locationKey}`);
        };
            ...
            >
              ...
              {Object.entries(locations).map(([key, location]) => (
                <Marker key={key} position={location.coordinates}>
                  ...
                  {/* pop up to show locations and have open datagram button */}
                  <Popup>
                  ...
                  <div className="flex flex-col gap-2 text-center">  
                      ...
                      <button className='bg-blue-600 text-white p-2 mt-2 rounded-lg hover:bg-blue-500'
                      onClick={() => handleShowDatagram(key)}>
                        Show Datagram
