    ...
    <div className="flex flex-col min-h-screen w-full max-w-full overflow-x-hidden">
      <div className="flex flex-col md:flex-row flex-1 p-6 gap-8">
            ...
            <div className="flex flex-col h-full">
              ...
              <div className="mb-6 space-y-4">
               ...
               <button
                ...
                className="w-full bg-blue-600 text-white py-1 mt-4 rounded-sm hover:bg-blue-500"
              >
                Generate graph
              </button>
        ...
        <div className="w-full md:w-2/3 lg:w-3/4 flex-grow">
          ...
          {/* Download Controls with Map Button */}
          {showDownloadSection && (
          ...
          {/* Visualization Area */}
          <div className="mb-16 w-full border flex p-10 justify-center items-center border-black rounded-md bg-white shadow-md overflow-hidden">
            {isLoading ? (
